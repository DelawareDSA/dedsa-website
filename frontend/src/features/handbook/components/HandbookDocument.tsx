...
export default function HandbookDocument({ data }: HandbookDocumentProps) {
  return (
      ...
      <div className="p-8 text-center border-2 rounded-lg border-dsa-red bg-gradient-to-br from-red-50 to-white">
        <div className="mb-6">
          ...
          <h3 className="mb-2 text-2xl font-bold text-gray-900">
            Delaware DSA Membership Handbook
          </h3>
          <p className="mb-6 text-xl text-gray-600">
            Your complete guide to getting involved with our chapter,
            understanding our structure, and participating in democratic
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <a
            href={data.pdfUrl}
            download="Delaware-DSA-Handbook.pdf"
        ...
        <div className="mt-6 text-sm text-center text-gray-600">
          <p className="text-xl">PDF file • Last updated: December 2024</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 mt-8 md:grid-cols-3">
        <div className="p-4 rounded-lg bg-gray-50">
          ...
          <p className="text-sm text-gray-600">
            Everything you need to know to get started with Delaware DSA and
        ...
        <div className="p-4 rounded-lg bg-gray-50">
          ...
          <p className="text-sm text-gray-600">
            Find the right committee or working group to match your interests
            and get involved
          </p>
        </div>
        <div className="p-4 rounded-lg bg-gray-50">
          ...
          <p className="text-sm text-gray-600">
            Tools, training, and resources to help you become an effective
            democratic socialist organizer
          </p>
        </div>
      </div>
