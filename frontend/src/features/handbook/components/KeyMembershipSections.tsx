...
export default function KeyMembershipSections({
  data,
}: KeyMembershipSectionsProps) {
  const sections = data.keyMembershipSections || [];

  return (
    <div className="p-8 mb-8 bg-white rounded-lg shadow-md">
      <h2 className="mb-6 text-2xl font-bold">Key Handbook Sections</h2>
      <p className="mb-6 text-gray-600">
        Our membership handbook provides comprehensive guidance for democratic
        socialist organizing and chapter participation. Click the links below to
        jump to specific sections in the PDF document.
      </p>
